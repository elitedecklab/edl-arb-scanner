...
PRIORITY_SETS = ["Ascended Heroes", "Destined Rivals", "Prismatic Evolutions", "Black Bolt",
                 ...
                 "Mega Evolution", "Perfect Order", "Chaos Rising",
                 ...
                 "Stellar Crown"]
                 # NOTE: "Pitch Black" (5th Mega Evolution set) releases 2026-07-17 and
                 # isn't in Pokedata's catalog yet. Re-run find_set_ids.py after release
                 # and add it + its set_id to SETID_FALLBACK below.
...
SETID_FALLBACK = {"ascended heroes": 3591, "destined rivals": 567, "prismatic evolutions": 557,
                  ...
                  # Mega Evolution era
                  "mega evolution": 574, "perfect order": 3665, "chaos rising": 3850,
